...
fun sendServerPinMail(receiver: User, serverpin: String){
    ...
    val mail = MailSender(receiverAddresses = mutableListOf(receiver.emailAdress!!), subject = "Einrichtung Ihrer Docsrv Instanz", content = email)
...
class MailSender(
    ...
    constructor(receiverAddresses: List<String>,
                ...
                attachmentFile: File? = null) : this(receiverAddresses, subject, content.asHtml(), date, attachmentFile)
    ...
    fun send(): Boolean {
        ...
        props.put("mail.smtps.host", Config.instance.smtpServer)
        props.put("mail.smtps.auth", "true")

        val session: Session = Session.getInstance(props, null)
        val msg = MimeMessage(session)

        msg.setFrom(InternetAddress(Config.instance.fromAddress))
        ...
        t.connect(Config.instance.smtpServer, Config.instance.smtpUser, Config.instance.smtpPassword)
